...
SEED_PROPERTIES = [
    {
        ...
        "description": "A modernist cliff-top villa framed by floor-to-ceiling glass, an infinity pool, and unobstructed ocean views. Designed by award-winning architects with imported Italian finishes throughout.",
        "price": 4850000,
        "type": "villa", "listing_type": "sale",
        "bedrooms": 5, "bathrooms": 6, "area": 6800,
        "city": "Malibu", "address": "34 Coastal Ridge, Malibu, CA",
        "images": [
            "https://images.unsplash.com/photo-1544984243-ec57ea16fe25?crop=entropy&cs=srgb&fm=jpg&q=85&w=1600",
    ...
    },
    {
        ...
        "description": "A meticulously restored heritage residence blending original 1920s bones with a sculptural modern extension. Walled garden and a private studio.",
        "price": 2150000,
        ...
        "amenities": ["Garden", "Studio", "Fireplace", "Heritage Details"],
        "featured": True, "status": "available",
    },
    {
        "title": "Kestrel Loft — Downtown Penthouse",
        "description": "Sky-lit penthouse in the arts district with cast-iron columns, oak flooring, and a private roof terrace overlooking the skyline.",
        "price": 3200,
        ...
        "images": [
            ...
            "https://images.pexels.com/photos/13722886/pexels-photo-13722886.jpeg?auto=compress&cs=tinysrgb&w=1600",
        ],
        "amenities": ["Roof Terrace", "Doorman", "Gym", "Loft Ceilings"],
        "featured": True, "status": "available",
    },
    {
        "title": "Meadow House by the Vineyard",
        "description": "A quiet country retreat surrounded by vineyards, olive groves, and lavender. Timber-clad exterior and light-drenched interiors.",
        "price": 1420000,
        "type": "house", "listing_type": "sale",
        ...
        "amenities": ["Vineyard View", "Pool", "Guest House", "Outdoor Kitchen"],
        "featured": False, "status": "available",
    },
    {
        "title": "The Terrace at Marina Bay",
        "description": "Contemporary two-bedroom apartment with wraparound terrace and marina frontage. Minimal, warm interiors with brushed brass fixtures.",
        "price": 895000,
        ...
        "amenities": ["Marina View", "Concierge", "Pool", "Fitness Center"],
        "featured": True, "status": "available",
    },
    {
        "title": "Cedar & Stone Retreat",
        "description": "A brutalist-influenced mountain house wrapped in cedar and local stone. Vaulted living hall and glazed corner facing the alpine ridge.",
        "price": 1780000,
        "type": "house", "listing_type": "sale",
        ...
        "amenities": ["Mountain View", "Sauna", "Fireplace", "Ski Storage"],
        "featured": False, "status": "available",
    },
    {
        "title": "Studio No. 17 — Arts Quarter",
        "description": "Compact but beautifully proportioned studio with double-height windows, a mezzanine sleeping loft, and shared rooftop garden.",
        "price": 1800,
        "type": "apartment", "listing_type": "rent",
        ...
        "amenities": ["Mezzanine", "Rooftop", "Bike Storage"],
        "featured": False, "status": "available",
    },
    {
        "title": "Casa Luz — Adobe Villa",
        "description": "Sun-baked adobe villa with courtyard fountains, hand-hewn beams, and locally quarried stone floors. Pure Mediterranean calm.",
        "price": 2650000,
        "type": "villa", "listing_type": "sale",
        ...
        "images": [
            ...
            "https://images.unsplash.com/photo-1600607687126-c2ef9f4b5b78?auto=format&fit=crop&w=1600&q=80",
        ],
        "amenities": ["Courtyard", "Adobe Fireplace", "Guest Casita", "Pool"],
        "featured": False, "status": "available",
    },
    {
        "title": "Blackwood Modern",
        "description": "Sculptural blackened-timber house cantilevered over a wooded creek. Open-plan living with a monolithic concrete hearth.",
        "price": 2380000,
        "type": "house", "listing_type": "sale",
        ...
        "amenities": ["Creek View", "Concrete Hearth", "Home Office", "Rooftop Deck"],
        "featured": True, "status": "available",
    },
    {
        "title": "Harbor Point Land Parcel",
        "description": "A rare 2.3-acre buildable parcel with harbor frontage. Development-ready with all utilities to lot line.",
        "price": 780000,
        ...
        "amenities": ["Waterfront", "Buildable", "Utilities Ready"],
        "featured": False, "status": "available",
    },
]
